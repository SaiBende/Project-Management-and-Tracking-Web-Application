    ...
    return (
        <>
            <section className=''>
                ...
                <aside id="sidebar-multi-level-sidebar" className={`relative top-0 left-0 z-40 w-64 h-screen transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 bg-gray-50 dark:bg-gray-800`} aria-label="Sidebar">
